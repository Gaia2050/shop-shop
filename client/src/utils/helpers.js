...
export function idbPromise(storeName, method, object) {
  return new Promise((resolve, reject) => {
    ...
    //if version has changed (or if this is the first time using the database), run this command and create the three object stores
    ...
    request.onsuccess = function (e) {
      ...
      //if there are no errors, let us know
